...
<?php if ($pageMode == 'edit'): ?>
        <tr>
            ...
            <td style="text-align: left;"><label class="custom-checkbox"> <input type="checkbox" class="hidden-checkbox" id="changePassword" name="change_password" {{ $change_password }}> <span class="checkmark"></span></label></td>
        </tr>
<?php endif; ?>        
