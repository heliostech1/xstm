...
<?php if ($pageMode == 'edit' || $pageMode == 'view'): ?>  
        ...
        <tr>
            <td class="formLabel" style='width:200px' >ชื่อ นามสกุล:</td>
...
<table cellspacing="0" border="0" cellpadding="0" class="formTable">
    <tbody>      
        <tr>
            <td class="formLabel"  style='width:200px' >วันที่เริ่มงาน:</td>
        ...
        <tr>
            <td class="formLabel">สถานะการทำงาน:</td>
