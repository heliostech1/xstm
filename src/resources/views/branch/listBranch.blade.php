    ...
    <table cellspacing="0" border="0" cellpadding="0" class="formTable" id="searchForm">
        <tr>
            <td>
                ...
                <input class="textInput" type="text" style="width:120px" id="<?php echo $fieldNames['branch_code']?>" value='<?php echo $fieldDatas['branch_code']?>'>                
                 &nbsp;   
...
<div class='footerBtnCont'>
   {!! SiteHelper::footerBtn('branch/add', ' value="เพิ่ม" id="addBtn"  ') !!}
   {!! SiteHelper::footerBtn('branch/edit', ' value="แก้ไข" id="editBtn" '); !!}
   {!! SiteHelper::footerBtn('branch/view', ' value="เรียกดู" id="viewBtn"  '); !!}
   {!! SiteHelper::footerBtnRight('branch/delete', ' value="ลบ" id="deleteBtn" '); !!}
