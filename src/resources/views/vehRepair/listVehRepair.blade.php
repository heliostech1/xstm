...
$(document).ready(function() {
    ...
    $( "#<?php echo $fieldNames['fixDateFrom']?>" ).datepicker();
    $( "#<?php echo $fieldNames['fixDateTo']?>" ).datepicker();
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="formTable" id="searchForm">
        ...
        <tr>
            <td>
                ...
                <span class="formLabel">วันที่ซ่อมบำรุง:</span>
                <input class="textInput" type="text" style="width:90px" id="<?php echo $fieldNames['fixDateFrom']?>" value='<?php echo $fieldDatas['fixDateFrom']?>' autocomplete="off" >                
                - 
                <input class="textInput" type="text" style="width:90px" id="<?php echo $fieldNames['fixDateTo']?>" value='<?php echo $fieldDatas['fixDateTo']?>' autocomplete="off" >                
...
<table id='resultListTable' cellspacing='0' cellpadding='0' class='display'>
    <thead>
        <tr>
            ...
            <th  width='90'>วันที่ซ่อมบำรุง</th>
            <th  width='90'>วันที่ซ่อมเสร็จ</th>
            <th  width='180'>หัวข้อการซ่อมบำรุง</th>
            <th  width='180'>รายการซ่อม</th>
            <th  width='90'>เลขไมล์</th>
...
<div class='footerBtnCont'>
   {!! SiteHelper::footerBtn('vehRepair/add', ' value="เพิ่ม" id="addBtn"  ') !!}
   {!! SiteHelper::footerBtn('vehRepair/edit', ' value="แก้ไข" id="editBtn" '); !!}
   {!! SiteHelper::footerBtn('vehRepair/view', ' value="เรียกดู" id="viewBtn"  '); !!}      
   {!! SiteHelper::footerBtnRight('vehRepair/delete', ' value="ลบ" id="deleteBtn" '); !!}
