...
class HealthCheckByRangeExcel extends HealthCheckBaseExcel
{
    ...
    public function generate($input) {
        ...
        $this->setContentValue($this->getCurrentPos(), "รายงานสรุปผลการตรวจสุขภาพตามช่วงเวลา", true);
     ...
     //   $this->setResultTableHeader($this->getNextColPos(), "ผลตรวจสารเสพติด");
        ...
        $order = 0 ;
        foreach ($input['reportDataRows'] as $driverId => $itemDataRows) { 
            $orderInGroup = 0;
